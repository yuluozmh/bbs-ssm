			...
			<div class="row">
				...
				<div class="col-md-10 col-xs-12">
					...
					<div class="row">
						...
						<%--<div class="col-md-3 col-xs-5 col-md-offset-3 col-xs-offset-7">
							<a href="${APP_PATH}/album.jsp">
								<button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-road"></span> 进入她的相册</button>
							</a>
						</div>--%>
					</div>
					<br>
					...
					<div role="tabpanel" class="tab-pane active" id="home">
						...
						<div id="article_null" style="display: none;">
							...
							<div class="text-center">
								...
								<p style="color: #999999">她很懒，还没有写过文章</p>
							</div>
							<br><br><br><br>
						</div>
					...
					<div role="tabpanel" class="tab-pane" id="profile">
						...
						<div id="huifu_article_null" style="display: none;">
							...
							<div class="text-center">
								...
								<p style="color: #999999">她很懒，还没有评论过任何文章</p>
							</div>
							<br><br><br><br>
						</div>
					...
					<div role="tabpanel" class="tab-pane" id="attention">
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active">
								<a href="#icare" aria-controls="icare" role="tab" data-toggle="tab">她的关注 <samp id="attention_count"></samp></a>
							</li>
							<li role="presentation">
								<a href="#careme" aria-controls="careme" role="tab" data-toggle="tab">她的粉丝 <samp id="attention_count_be"></samp></a>
							</li>
						</ul>
						<div class="tab-content">
							<!-- 我关注的 -->
							<div role="tabpanel" class="tab-pane active" id="icare">
								...
								<div id="attention_null" style="display: none;">
									...
									<div class="text-center">
										...
										<p style="color: #999999">可能，她还没遇见感兴趣的人</p>
									</div>
									<br><br><br><br>
								</div>
								<br>
							...
							<div role="tabpanel" class="tab-pane" id="careme">
								...
								<div id="attention_be_null" style="display: none;">
									...
									<div class="text-center">
										...
										<p style="color: #999999">可能，她并不是别人的菜</p>
									</div>
									<br><br><br><br>
								</div>
								<br>
					...
					<div role="tabpanel" class="tab-pane" id="collect">
						...
						<div id="collect_null" style="display: none;">
							...
							<div class="text-center">
								...
								<p style="color: #999999">可能，她还没遇见感兴趣的文章</p>
							</div>
							<br><br><br><br>
						</div>
						<br>
